Title: Add Auto Updates Evidence

URL Source: https://developers.drata.com/developer-portal/v2/recipes/add-auto-updates-evidence/
...
## [](https://developers.drata.com/developer-portal/v2/recipes/add-auto-updates-evidence/#step-1-get-list-of-personnel)Step 1: Get list of personnel
...
## [](https://developers.drata.com/developer-portal/v2/recipes/add-auto-updates-evidence/#step-2-get-device-id)Step 2: Get Device ID
...
## [](https://developers.drata.com/developer-portal/v2/recipes/add-auto-updates-evidence/#step-3-attach-file-for-that-device)Step 3: Attach file for that device
...
## [](https://developers.drata.com/developer-portal/v2/recipes/add-auto-updates-evidence/#step-4-confirm-upload-has-updated-personnels-compliance)Step 4: Confirm upload has updated personnel’s compliance
...
## [](https://developers.drata.com/developer-portal/v2/recipes/add-auto-updates-evidence/#step-5-repeat-for-each-personnel-failing-auto-update-compliance)Step 5: Repeat for each personnel failing auto-update compliance
